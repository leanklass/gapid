...
func TestParseLog(t *testing.T) {
	...
	str := `ǁa5eaebbe90d60b560e08a6750958755a58e6f999ǀBen Clayton <bclayton@google.com>ǀMerge pull request #157 from google/fix_freetypeǀUpdate freetype path and fix for breaking changes.ǀ2017-03-10T11:08:35-08:00
  ǁf3cdfb4d9b662e0d66b5779d02370115e136a008ǀBen ClaytonǀUpdate freetype path and fix for breaking changes.ǀǀ2017-03-10T11:08:36-08:00
  ǁ92ee22e53df7b361224670cf0f5ce4b12cdbc040ǀBen Clayton <bclayton@google.com>ǀMerge pull request #154 from google/recreate_ctrlsǀAdd recreateControls flag to the OnDataChanged list/tree event.ǀ2017-03-10T11:08:37-08:00
  ǁ73c5a5ba67edfd06d20f9f52249b06984a324d0cǀMr4xǀUpdated Grid Layoutǀǀ2017-03-10T11:08:38-08:00
  ǁ1d039c122e95122e68e5862aab3580bba15bd1adǀMr4xǀMerge pull request #1 from google/masterǀUpdateǀ2017-03-10T11:08:39-08:00`
	expected := []ChangeList{
		{
			...
			Committed:   pt("2017-03-10T11:08:35-08:00"),
		},
		{
			...
			Committed: pt("2017-03-10T11:08:36-08:00"),
		},
		{
			...
			Committed:   pt("2017-03-10T11:08:37-08:00"),
		},
		{
			...
			Committed: pt("2017-03-10T11:08:38-08:00"),
		},
		{
			...
			Description: "Update",
			Committed:   pt("2017-03-10T11:08:39-08:00"),
		},
	}
	cls, err := parseLog(str)
	assert.With(ctx).ThatError(err).Succeeded()
	assert.With(ctx).ThatSlice(cls).DeepEquals(expected)
}
